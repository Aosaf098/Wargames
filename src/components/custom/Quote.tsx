...
const Quote = () => {
  return (
    <>
      <div className="w-3/4 mx-auto h-[350px] my-20 relative flex items-center justify-center">
        <img
          className="absolute opacity-30 w-full h-full object-cover rounded-xl"
          src={quoteBg}
          alt=""
        />
        <p className="text-3xl text-white bg-black/10 font-black text-center drop-shadow-lg leading-snug">
